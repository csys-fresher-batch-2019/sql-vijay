...
insert into doctors(doctor_id,doctorname,specialization)
values('D01','suraj','Pediatrician');
insert into doctors(doctor_id,doctorname,specialization)
values('D02','vetri','Cardiologist');
insert into doctors(doctor_id,doctorname,specialization)
values('D03','tamizh','Nephrologist');
insert into doctors(doctor_id,doctorname,specialization)
values('D04','harish','Ophthalmologist');
